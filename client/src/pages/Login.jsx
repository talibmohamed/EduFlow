...
export default function Login() {
  ...
  // Ajout de l'état pour la visibilité du mot de passe
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 font-sans selection:bg-blue-200">
      ...
      <main className="flex flex-1 items-center justify-center p-6 pb-24">
        <div className="w-full max-w-[26rem] rounded-[2rem] border border-slate-100 bg-white p-8 shadow-2xl shadow-slate-200/50 sm:p-10">
          
          <h1 className="mb-2 text-3xl font-extrabold tracking-tight text-slate-900">
            Bon retour 👋
          </h1>
          <p className="mb-8 text-sm font-medium text-slate-500">
            Connecte-toi pour accéder à ton espace EduFlow.
          </p>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input
                ...
                classNames={{ inputWrapper: "bg-white border-slate-300 hover:border-slate-500 h-12" }}
              />
            </div>

            {/* Champ Mot de passe modifié avec le bouton oeil */}
            <div className="flex flex-col gap-2">
              ...
              <Input
                ...
                classNames={{ inputWrapper: "bg-white border-slate-300 hover:border-slate-500 h-12 pr-2" }}
                endContent={
          ...
          <p className="mt-8 text-center text-sm font-medium text-slate-500">
            ...
            <Link className="font-bold text-edublue hover:underline" to="/register">
              Créer un compte
            </Link>
          </p>
        </div>
